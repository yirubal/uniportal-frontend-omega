...
export const MOCK_RESOURCES: Resource[] = [
    {
        ...
        status: "published",
        course_codes: ["CS301"],
        course_names: ["Data Structures & Algorithms"],
        downloads_count: 432,
    ...
    },
    {
        ...
        status: "published",
        course_codes: ["CS410"],
        course_names: ["Computer Networks"],
        downloads_count: 254,
    ...
    },
    {
        ...
        status: "published",
        course_codes: ["CS450"],
        course_names: ["Software Engineering"],
        downloads_count: 91,
    ...
    },
    {
        ...
        status: "published",
        course_codes: ["CS460"],
        course_names: ["Artificial Intelligence"],
        downloads_count: 118,
